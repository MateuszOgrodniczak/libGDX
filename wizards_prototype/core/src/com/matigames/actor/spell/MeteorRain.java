...
public class MeteorRain extends Spell {
    ...
    public MeteorRain(float x, float y, Stage s) {
        super(x, y, s);
        ...
        for (int i = 0; i < METEORS_TOTAL; i++) {
            ...
            addAction(Actions.after(new CastMeteorAction(this.getStage(), subspells)));
        }
    }
    ...
    public class CastMeteorAction extends Action {
        ...
        CastMeteorAction(Stage stage, List<Spell> meteors) {
            this.stage = stage;
        ...
        public boolean act(float delta) {
            ...
            meteors.add(new Meteor(x, y, stage));
            return true;
        }
    }
