...
public class PlayerEntity implements Serializable {
    ...
    private int newAudioSignals;
    private boolean thrustersVisible;
    private boolean hasLasers;
    ...
    public int getNewAudioSignals() {
        return newAudioSignals;
    }

    public void setNewAudioSignals(int newAudioSignals) {
        this.newAudioSignals = newAudioSignals;
    }
}
